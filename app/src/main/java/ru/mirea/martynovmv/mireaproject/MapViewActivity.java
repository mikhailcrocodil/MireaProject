...
import ru.mirea.martynovmv.mireaproject.databinding.ActivityMainBinding;
import ru.mirea.martynovmv.mireaproject.databinding.ActivityMapViewBinding;
...
public class MapViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("FKJDJL",String.valueOf(isWork));
    ...
    public void placeIcon(String text, Integer drawable, Double lat, Double lon){
        ...
        marker.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(MapViewActivity.this, text, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        mapView.getOverlays().add(marker);
