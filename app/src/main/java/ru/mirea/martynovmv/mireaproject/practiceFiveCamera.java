 ...
 * Use the {@link practiceFiveCamera#newInstance} factory method to
 * create an instance of this fragment.
 */
public class practiceFiveCamera extends Fragment {
    ...
    private FragmentPracticeFiveCameraBinding binding;
     ...
     * @return A new instance of fragment practiceFiveCamera.
     */
    // TODO: Rename and change types and number of parameters
    public static practiceFiveCamera newInstance(String param1, String param2) {
        practiceFiveCamera fragment = new practiceFiveCamera();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        super.onCreate(savedInstanceState);
        binding = FragmentPracticeFiveCameraBinding.inflate(inflater, container, false);
        View v = binding.getRoot();
        mContext = inflater.getContext();

        int	cameraPermissionStatus = ContextCompat.checkSelfPermission(mContext, android.Manifest.permission.CAMERA);
        int	storagePermissionStatus = ContextCompat.checkSelfPermission(mContext,
